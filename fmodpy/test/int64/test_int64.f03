...
! Function returning allocatable.
FUNCTION TEST_ALLOCATABLE_RETURN(N)
  USE ISO_FORTRAN_ENV, ONLY: INT64
  IMPLICIT NONE
  INTEGER(KIND=INT64), INTENT(IN) :: N
  INTEGER(KIND=INT64), ALLOCATABLE :: TEST_ALLOCATABLE_RETURN(:)
  INTEGER :: I
  ALLOCATE(TEST_ALLOCATABLE_RETURN(1:N))
  DO I = 1, N
     TEST_ALLOCATABLE_RETURN(I) = N - I
  END DO
END FUNCTION TEST_ALLOCATABLE_RETURN
