...
USE ISO_FORTRAN_ENV , ONLY : REAL64
  ...
  REAL(KIND=REAL64), INTENT(IN), DIMENSION(ARRAY_IN_DIM_1) :: ARRAY_IN

  INTEGER, INTENT(IN) :: ARRAY_OUT_DIM_1
  REAL(KIND=REAL64), INTENT(OUT), DIMENSION(ARRAY_OUT_DIM_1) :: ARRAY_OUT

  INTEGER, INTENT(IN) :: KNOWN_ARRAY_OUT_DIM_1
  REAL(KIND=REAL64), INTENT(OUT), DIMENSION(KNOWN_ARRAY_OUT_DIM_1) :: KNOWN_ARRAY_OUT

  INTEGER, INTENT(IN) :: KNOWN_MATRIX_OUT_DIM_1
  INTEGER, INTENT(IN) :: KNOWN_MATRIX_OUT_DIM_2
  REAL(KIND=REAL64), INTENT(OUT), DIMENSION(KNOWN_MATRIX_OUT_DIM_1,KNOWN_MATRIX_OUT_DIM_2) :: KNOWN_MATRIX_OUT

  LOGICAL, INTENT(IN) :: OPT_SING_IN_PRESENT
  REAL(KIND=REAL64), INTENT(IN) :: OPT_SING_IN

  LOGICAL, INTENT(IN) :: OPT_SING_OUT_PRESENT
  REAL(KIND=REAL64), INTENT(OUT) :: OPT_SING_OUT
  ...
  INTERFACE
    ...
    IMPLICIT NONE
      REAL(KIND=REAL64), INTENT(IN) :: SING_IN
      REAL(KIND=REAL64), INTENT(OUT) :: SING_OUT
      REAL(KIND=REAL64), INTENT(IN), DIMENSION(:) :: ARRAY_IN
      REAL(KIND=REAL64), INTENT(OUT), DIMENSION(:) :: ARRAY_OUT
      REAL(KIND=REAL64), INTENT(OUT), DIMENSION(SIZE(ARRAY_OUT)) :: KNOWN_ARRAY_OUT
      REAL(KIND=REAL64), INTENT(OUT), DIMENSION(3,SIZE(ARRAY_OUT)) :: KNOWN_MATRIX_OUT
...
USE ISO_FORTRAN_ENV , ONLY : REAL64
  ...
  REAL(KIND=REAL64), INTENT(IN), DIMENSION(OPT_ARRAY_IN_DIM_1) :: OPT_ARRAY_IN

  LOGICAL, INTENT(IN) :: KNOWN_OPT_ARRAY_OUT_PRESENT
  INTEGER, INTENT(IN) :: KNOWN_OPT_ARRAY_OUT_DIM_1
  REAL(KIND=REAL64), INTENT(OUT), DIMENSION(KNOWN_OPT_ARRAY_OUT_DIM_1) :: KNOWN_OPT_ARRAY_OUT

  LOGICAL, INTENT(IN) :: OPT_ALLOC_ARRAY_OUT_PRESENT
  INTEGER, INTENT(OUT) :: OPT_ALLOC_ARRAY_OUT_DIM_1
  REAL(KIND=REAL64), ALLOCATABLE, SAVE, DIMENSION(:) :: OPT_ALLOC_ARRAY_OUT_LOCAL
  INTEGER(KIND=INT64), INTENT(OUT) :: OPT_ALLOC_ARRAY_OUT

  INTEGER, INTENT(OUT) :: ALLOC_ARRAY_OUT_DIM_1
  REAL(KIND=REAL64), ALLOCATABLE, SAVE, DIMENSION(:) :: ALLOC_ARRAY_OUT_LOCAL
  ...
  INTERFACE
    ...
    USE ISO_FORTRAN_ENV , ONLY : REAL64
    IMPLICIT NONE
      REAL(KIND=REAL64), INTENT(IN), OPTIONAL, DIMENSION(:) :: OPT_ARRAY_IN
      REAL(KIND=REAL64), INTENT(OUT), OPTIONAL, DIMENSION(3) :: KNOWN_OPT_ARRAY_OUT
      REAL(KIND=REAL64), INTENT(OUT), OPTIONAL, ALLOCATABLE, DIMENSION(:) :: OPT_ALLOC_ARRAY_OUT
      REAL(KIND=REAL64), ALLOCATABLE, DIMENSION(:) :: ALLOC_ARRAY_OUT
      INTEGER, INTENT(IN) :: N
